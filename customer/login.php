<?php
$page_title = "Customer Portal Login | Digital Udyog Seva";
require_once __DIR__ . '/../config/app.php';
require_once __DIR__ . '/../includes/auth.php';
require_once __DIR__ . '/../includes/csrf.php';

$error = '';
$email_val = $_POST['email'] ?? '9876500001';
$password_val = $_POST['password'] ?? 'Customer@123';
...
<head>
    ...
    <style>
        :root {
            ...
            --accent-glow: radial-gradient(circle at 50% 0%, rgba(13, 148, 136, 0.25) 0%, transparent 70%);
        }
        body {
        ...
        .login-card {
            ...
            border-radius: 24px;
            box-shadow: 0 25px 50px -12px rgba(0, 0, 0, 0.5), 0 0 30px rgba(13, 148, 136, 0.15);
            max-width: 480px;
            width: 100%;
...
<body>
    ...
    <div class="login-card">
        ...
        <div class="text-center mb-4">
            <div class="brand-badge-customer mb-3">
                <i class="bi bi-person-circle"></i> CUSTOMER PORTAL
            </div>
            <h2 class="font-heading fw-bold mb-1">Customer Login</h2>
            <p class="text-secondary small mb-0">Access your service cases, loan apps & scorecards</p>
        </div>
        ...
        <form action="" method="POST">
            ...
            <div class="mb-3">
                <label class="form-label small fw-bold text-light">Mobile or Email Address</label>
                <div class="input-group">
                    <input type="text" name="email" class="form-control form-control-custom" required value="<?php echo htmlspecialchars($email_val); ?>" placeholder="Enter mobile or email">
                </div>
            </div>
            ...
            <button type="submit" class="btn btn-login w-100 mb-3">
                Customer Sign In <i class="bi bi-arrow-right-short fs-5 ms-1"></i>
            </button>
        </form>
