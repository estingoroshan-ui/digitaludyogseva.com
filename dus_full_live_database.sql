...
-- 16. Multi-Brand & Multi-Company Table
...
-- 17. Service Workflows Table (Dynamic Task Sequence per Service)
...
-- 18. Service Document Checklists Table
...
-- 19. External Assignments Table (CA / CS / Advocate / Consultant Outsourcing)
...
-- 20. Business Ecosystem Requirements Table (Machinery, Raw Materials, Manpower)
...
-- 21. Recurring Cycles Table (GST, ITR, Compliance Auto-Cycle Engine)
...
-- 22. Communication Logs Table (Official Customer WhatsApp/Email/SMS Audit Log)
...
-- 23. Lead Statuses Table (20 Pipeline Stages)
